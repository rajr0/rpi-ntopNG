...
# root@OpenWrt:~#  softflowd -D -v 5 -i br-lan -n 192.168.0.182:5556 -T full 
# root@OpenWrt:~#  softflowd -D -v 5 -i eth1   -n 192.168.0.182:5556 -T full 
# root@OpenWrt:~#  softflowd -D -v 5 -i eth0   -n 192.168.0.182:5556 -T full
...
# 3. ntopng to listen on --zmq tcp://127.0.0.1:5557

CMD nprobe --collector-port 5556  --zmq tcp://*:5557 -G && \
    /etc/init.d/redis-server start && \
    ntopng -i "tcp://127.0.0.1:5557"
